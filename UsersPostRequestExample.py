...
U = Users()
# Refer to https://snipe-it.readme.io/v4.0/reference#users-2 for fields
payload = '{"username":"test_user1","first_name":"Test","password":"testing123"}'
r = U.create(server, token, payload)
print r
